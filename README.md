...
依教育部 **108 課綱**自然科學領域物理設計的高中物理互動模擬網站。全站繁體中文，涵蓋必修物理與選修物理加深加廣內容，提供 **12 個學習模組、69 個實驗主題、69 個即時 canvas 互動模擬**。
...
- **100% 互動模擬**：69 個實驗全部可即時操作，不只是文字教材。
...
本專案目前包含 **12 個學習模組**，共 **69 個互動實驗**。

| 編號 | 模組 | 實驗數 | 互動實驗 |
| --- | --- | ---: | --- |
| 一 | 運動學 | 5 | 等加速度直線運動、自由落體、拋體運動、相對運動、運動圖形分析 |
| 二 | 牛頓運動定律與力 | 6 | 慣性、F=ma、斜面受力、靜/動摩擦、連接體與張力、牛頓第三定律 |
| 三 | 動量與碰撞 | 5 | 一維碰撞、動量守恆、衝量、二維碰撞、反衝與爆炸 |
| 四 | 功與能量 | 5 | 功與功率、功能定理、軌道力學能守恆、重力/彈性位能、保守力 |
| 五 | 圓周運動與萬有引力 | 6 | 等速圓周運動、向心力、萬有引力、行星軌道、人造衛星、角動量守恆 |
| 六 | 簡諧運動 | 5 | 彈簧振子、單擺、位移-時間關係、簡諧能量、共振 |
| 七 | 流體與熱學 | 6 | 浮力、白努利、理想氣體、氣體定律、熱平衡與比熱、熱力學第一定律 |
| 八 | 波動與聲音 | 6 | 橫波與縱波、波的疊加、弦上駐波、都卜勒效應、拍、共鳴管 |
| 九 | 光學 | 7 | 反射與折射、面鏡成像、透鏡成像、雙縫干涉、單狹縫繞射、偏振、色散 |
| 十 | 電場與電路 | 6 | 庫侖定律、電場線與等勢面、電位、歐姆定律、電阻串並聯、電容器充放電 |
| 十一 | 磁場與電磁感應 | 6 | 載流導線磁場、勞侖茲力、電磁感應、楞次定律、交流發電機、變壓器 |
| 十二 | 近代物理與宇宙學 | 6 | 光電效應、波耳模型、物質波、狹義相對論、放射性半衰期、哈伯定律 |
...
| `js/curriculum.js` | 12 模組、69 實驗的教材資料、公式與學習重點 |
