...
依教育部 **108 課綱**自然科學領域物理設計的高中物理互動模擬網站。全站繁體中文，涵蓋必修物理與選修物理加深加廣內容，提供 **12 個學習模組、84 個實驗主題、84 個即時 canvas 互動模擬**。
...
- **100% 互動模擬**：84 個實驗全部可即時操作，不只是文字教材。
...
| 十 | 電場與電路 | 9 | 庫侖定律、電場線與等勢面、電位與電位能、歐姆定律與電路、閉合電路：電動勢與內電阻量測、電阻的串聯與並聯、電容器充放電、惠斯登電橋、帶電粒子在電場中的偏轉 |
...
| `js/curriculum.js` | 12 模組、84 實驗的教材資料、公式與學習重點 |
