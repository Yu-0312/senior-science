...
依教育部 **108 課綱**自然科學領域物理設計的高中物理互動模擬網站。全站繁體中文，涵蓋必修物理與選修物理加深加廣內容，提供 **12 個學習模組、156 個實驗主題、156 個即時 Canvas 互動模擬**。
...
- **100% 互動模擬**：156 個實驗全部可即時操作，不只是文字教材或靜態插圖。
...
本專案目前包含 **12 個學習模組**，共 **156 個互動實驗**。除了核心課綱與第二批量測延伸，第三批再把常見進階概念、工程應用與實驗資料分析拆成獨立的互動量測台。

| 編號 | 模組 | 實驗數 | 互動實驗 |
| --- | --- | ---: | --- |
| 一 | 運動學 | 14 | 向量、運動圖像、終端速度、資料擬合、變因控制、誤差傳遞與量綱分析 |
| 二 | 牛頓運動定律與力 | 13 | 受力、摩擦、張力、超重失重、彈簧，以及滾動不滑動 |
| 三 | 動量與碰撞 | 10 | 碰撞、衝量、質心、火箭方程式與多級火箭分離 |
| 四 | 功與能量 | 8 | 功、功率、效率、保守力與摩擦耗散 |
| 五 | 圓周運動與萬有引力 | 15 | 向心力、轉動、衛星、逃逸、霍曼轉移與潮汐／洛希極限 |
| 六 | 簡諧運動 | 8 | 彈簧、單擺、能量、共振、阻尼、相位與耦合振子 |
| 七 | 流體與熱學 | 13 | 流體、氣體、相變、熱機、熱傳遞、膨脹、黏滯與液壓系統 |
| 八 | 波動與聲音 | 10 | 波形、干涉、駐波、都卜勒、聲強、共鳴管與惠更斯波前 |
| 九 | 光學 | 14 | 反射折射、干涉繞射、偏振、薄膜干涉、馬呂士定律與光速量測 |
| 十 | 電場與電路 | 16 | 電場、電路、電容、基爾霍夫定律、RL 暫態、整流、LED 與示波器 |
| 十一 | 磁場與電磁感應 | 16 | 磁場、感應、發電、霍爾效應、電流天平、渦電流、偏振與天線共振 |
| 十二 | 近代物理與宇宙學 | 19 | 量子能階、不確定性、相對論、核物理、系外行星、赫羅圖與宇宙距離梯 |
