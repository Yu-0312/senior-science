...
從國中自然的生活物理銜接到教育部 **108 課綱**自然科學領域物理的互動模擬網站。全站繁體中文，涵蓋國中基礎、必修物理與選修物理加深加廣內容，提供 **12 個學習模組、204 個實驗主題、204 個即時 Canvas 互動模擬**。
...
- **100% 互動模擬**：204 個實驗全部可即時操作，不只是文字教材或靜態插圖。
...
本專案目前包含 **12 個學習模組**，共 **204 個互動實驗**。除了核心課綱、量測延伸與進階應用，第四批將國中銜接、生活科技、工程裝置與各單元的關鍵概念拆成獨立的互動量測台。

| 編號 | 模組 | 實驗數 | 互動實驗 |
| --- | --- | ---: | --- |
| 一 | 運動學 | 17 | 單位換算、感測器、反應時間、向量、運動圖像、終端速度、資料擬合與量綱分析 |
| 二 | 牛頓運動定律與力 | 21 | 受力、牆面與疊放摩擦、輸送帶、兩繩平衡、張力、槓桿、滑輪、壓力、桁架、超重失重與彈簧 |
...
| 七 | 流體與熱學 | 18 | 密度、大氣壓力、表面張力、量熱、溫室效應、流體、氣體、相變、熱機與熱傳遞 |
| 八 | 波動與聲音 | 14 | 繩波波速、聲音三要素、回聲與超音波、地震波、干涉、駐波、都卜勒與共鳴管 |
| 九 | 光學 | 19 | 影子與針孔、RGB 混色、光纖、人眼、相機曝光、反射折射、干涉繞射、偏振與光速量測 |
| 十 | 電場與電路 | 20 | 靜電感應、焦耳熱、家庭電路、RLC 共振、電場、電容、基爾霍夫定律、整流、LED 與示波器 |
...
- **常見受力題型量測台**：新增牆面靜摩擦、疊放物體、兩繩懸掛與輸送帶四種互動題型；每個都有可調變因、力圖、即時判讀與關係圖。
