...
從國中自然的生活物理銜接到教育部 **108 課綱**自然科學領域物理的互動模擬網站。全站繁體中文，涵蓋國中基礎、必修物理與選修物理加深加廣內容，目前提供 **12 個學習模組、228 個實驗主題、228 個即時 Canvas 互動模擬**；目錄採資料驅動擴充，沒有預設的實驗或題型數量上限。
...
- **100% 互動模擬**：目前 228 個實驗全部可即時操作，不只是文字教材或靜態插圖。
...
本專案目前包含 **12 個學習模組**，共 **228 個互動實驗**。除了核心課綱、量測延伸與進階應用，目錄可由擴充檔不限批次新增；總數、首頁、搜尋、進度與模組導覽都會自動讀取最新資料，不需再手動改寫任何上限。
...
| 七 | 流體與熱學 | 22 | 密度、大氣壓力、表面張力、彈簧秤量浮力、量熱、溫室效應、流體、氣體、相變、熱機、熱傳遞、U 形管壓力計、比熱與導熱 |
| 八 | 波動與聲音 | 17 | 繩波波速、聲音三要素、回聲與超音波、地震波、干涉、駐波、都卜勒、共鳴管、P/S 波定位、弦的諧波與噪音屏障 |
| 九 | 光學 | 23 | 影子與針孔、RGB 混色、光纖、人眼、相機曝光、反射折射、透鏡位移法、干涉繞射、偏振、光速量測、透鏡組合、照度與稜鏡光譜儀 |
| 十 | 電場與電路 | 24 | 伏安法量電阻、靜電感應、焦耳熱、家庭電路、RLC 共振、電場、電容、基爾霍夫定律、整流、LED、示波器、分壓器、RC 計時與電解 |
| 十一 | 磁場與電磁感應 | 22 | 指南針與磁場、電磁鐵、直流馬達、感應、發電、霍爾效應、電流天平、渦電流、天線共振、正切電流計、迴旋頻率與互感 |
| 十二 | 近代物理與宇宙學 | 25 | 陰極射線、光譜、太陽能電池、量子能階、相對論、核物理、系外行星、赫羅圖、宇宙距離梯、蓋革統計、核能釋放與 GPS 校正 |
...
| `js/open-curriculum.js` | 第五批 18 個跨領域題型的教材資料，示範不限批次的目錄擴充 |
| `js/sim-core.js` | 自製模擬引擎，提供 UI、canvas、繪圖、graph、動畫 loop 等工具 |
| `js/app.js` | 網站導覽、搜尋、進度、主題、PWA 安裝與頁面狀態管理 |
| `js/experiments/*.js` | 各模組的互動模擬註冊檔；`comprehensive.js` 對應第四批 44 個專題場景，`open-labs.js` 對應第五批 18 個量測台 |
